...
byte mac[] = {0x12, 0x3A, 0x00, 0xBB, 0x03, 0x12};
...
const char* mqttTopic = "smartcity/trash/00003";
char* mqttPayload = "";

char *id = "20003"; // 2000x is for trash ID
unsigned long currentTime;
unsigned long prevTime = 0;
const int interval = 20000; //Interval time

float calibration_factor = 40175.00; 
#define zero_factor 8780309
#define DOUT  8
#define CLK   7
#define DEC_POINT  2
