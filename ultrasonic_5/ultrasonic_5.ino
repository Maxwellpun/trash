...
long prevTime = 0;
long prevTime2 = 0;
int sendTrashLevelInterval=20000; //Interval sending data to MQTT in 
int delayDropInterval=1200;

byte mac[] = {0x12, 0x3A, 0x00, 0xBB, 0x05, 0x11}; //แก้เลขตาม ID
...
const char *mqttTopic = "smartcity/trash/00005"; //แก้เลขตาม ID
char *mqttPayload;

const char *id = "10005"; //แก้เลขท้ายตาม ID
