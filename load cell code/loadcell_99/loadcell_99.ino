...
byte mac[] = {0x12, 0x3A, 0x00, 0xBB, 0x99, 0x12};
...
const char* mqttTopic = "smartcity/trash/00099";
char* mqttPayload = "";

char *id = "20099"; // 2000x is for trash ID
unsigned long currentTime;
unsigned long prevTime = 0;
const int interval = 20000; //Interval time

float calibration_factor = 44179.00; 
#define zero_factor 8350681
#define DOUT  8
#define CLK   7
#define DEC_POINT  2
