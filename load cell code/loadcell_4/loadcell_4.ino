...
byte mac[] = {0x12, 0x3A, 0x00, 0xBB, 0x04, 0x12};
...
const char* mqttTopic = "smartcity/trash/00004";
char* mqttPayload = "";

char *id = "20004"; // 2000x is for trash ID
unsigned long currentTime;
unsigned long prevTime = 0;
const int interval = 20000; //Interval time

float calibration_factor = 44742.00; 
#define zero_factor 7841916
#define DOUT  8
#define CLK   7
#define DEC_POINT  2
